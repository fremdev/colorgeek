<template>
  <div class="palette-item">
    ...
    <div class="palette-item__row">
      <div class="palette-item__color palette-item__color--big" :style="{backgroundColor: '#' + colors.color1.hex}">

      </div>
      <div class="palette-item__color palette-item__color--big" :style="{backgroundColor: '#' + colors.color2.hex}">

      </div>

    </div>
    <div class="palette-item__row">
      <div class="palette-item__color" :style="{backgroundColor: '#' + colors.color4.hex}">

      </div>
      <div class="palette-item__color" :style="{backgroundColor: '#' + colors.color5.hex}">

      </div>
      <div class="palette-item__color" :style="{backgroundColor: '#' + colors.color6.hex}">
    ...
    <div class="palette-item__footer">
      ...
      <div class="color-controls">
        ...
        <div class="color-type">
          <label class="form-check-label">
            <input class="form-check-input" type="radio" name="colorType" value="hex" checked>
            hex
          </label>
          <label class="form-check-label">
            <input class="form-check-input" type="radio" name="colorType" value="rgb">
            rgb
          </label>
        </div>
      </div>
