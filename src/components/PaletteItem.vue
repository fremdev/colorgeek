<template>
  <div class="palette-item">
    ...
    <div class="palette-item__row">
      <div
        v-if="!editMode"
        class="palette-item__color palette-item__color--big"
        :style="{backgroundColor: '#' + colors.color1.hex}"
        @click="editMode ? editColor() : copyColor()"
        :data-clipboard-text="'#' + colors.color1.hex"
      ></div>
      <div v-else
        class="color-picker color-picker--big"
        :style="{backgroundColor: color1}">
        <label class="color-picker__label">
          <input class="color-picker__input" type="color" v-model="color1">
        </label>
      </div>

      <div
        class="palette-item__color palette-item__color--big"
        :style="{backgroundColor: '#' + colors.color2.hex}"
        @click="editMode ? editColor : copyColor"
        :data-clipboard-text="'#' + colors.color2.hex"
      ></div>
    ...
    <div class="palette-item__row">
      <div
        ...
        :style="{backgroundColor: '#' + colors.color3.hex}"
        @click="editMode ? editColor : copyColor"
        :data-clipboard-text="'#' + colors.color3.hex"
      ></div>

      <div
        class="palette-item__color"
        :style="{backgroundColor: '#' + colors.color4.hex}"
        @click="editMode ? editColor : copyColor"
        :data-clipboard-text="'#' + colors.color4.hex"
      ></div>

      <div
        class="palette-item__color"
        :style="{backgroundColor: '#' + colors.color5.hex}"
        @click="editMode ? editColor : copyColor"
        :data-clipboard-text="'#' + colors.color5.hex"
      ></div>
    </div>
